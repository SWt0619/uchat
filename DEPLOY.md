...
| （无对应配置项） | — | 通话房间人数是代码常量：语音房 12 / 6 人、视频房 8 / 6 人（见 §4.2） |
...
8 人 = 每端 7 路上行（≈4 Mbps 纯视频码流），家庭宽带上不可行。因此 v2.9.0 起**按房间分别设上限**：语音房 12 / 6 人、视频房 8 / 6 人（代码常量 `VOICE_ROOM*_MAX` / `VIDEO_ROOM*_MAX`）。
...
| 画面模糊 / 卡顿 | 上行带宽不足 | 界面右下角角标会显示丢包率与带宽；Mesh 下视频房建议实际不超过 4–6 人 |
